...
import com.frameworkium.core.common.reporting.jira.dto.execution.ExecutionDto;
...
public class ExecutionUtil {
  ...
  private void updateStatusAndComment(Integer executionId, int status, String comment) {
    try {
      ...
      final UpdateExecutionOperationDto updateExecutionOperationDto =
          UpdateExecutionOperationDto.newBuilder()
              .status(status)
  ...
  private void deleteExistingAttachments(Integer executionId) {
    final AttachmentListDto executionListDto =
        attachment.getAttachmentByEntity(executionId, "EXECUTION");
