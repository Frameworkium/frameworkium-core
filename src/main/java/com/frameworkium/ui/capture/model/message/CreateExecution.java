package com.frameworkium.ui.capture.model.message;

import com.frameworkium.ui.capture.model.Browser;
import com.frameworkium.ui.capture.model.SoftwareUnderTest;
...
public final class CreateExecution {
    ...
    public CreateExecution(String testID, String nodeAddress) {
        ...
        logger.debug(String.format(
                "CreateExecution: testID='%s', nodeAddress='%s",
                testID, nodeAddress));
        this.testID = testID;
